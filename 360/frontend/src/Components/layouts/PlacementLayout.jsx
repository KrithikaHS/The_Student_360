...
const navigationItems = [
  {
    title: "Dashboard",
    url: createPageUrl("PlacementDashboard"),
  ...
  {
    title: "Registration",
    url: createPageUrl("Registrations"),
    icon: Download,
  },
];
        ...
        <Sidebar className="border-r border-gray-200 bg-white">
          <SidebarHeader className="border-b border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-gray-900">Placement Portal</h2>
                ...
                <SidebarMenu>
                  {navigationItems.map((item) => (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                        asChild
                        className={`hover:bg-purple-50 hover:text-purple-700 transition-all duration-200 rounded-xl mb-1 ${location.pathname === item.url ? 'bg-purple-50 text-purple-700 font-semibold' : ''
                          }`}
                      >
